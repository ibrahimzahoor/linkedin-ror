...
ActiveRecord::Schema.define(:version => 20131126200357) do
  ...
  create_table "alumnisearches", :force => true do |t|
    t.string   "name"
    t.string   "school"
    t.date     "startdate"
    t.date     "enddate"
  ...
  create_table "users", :force => true do |t|
    ...
    t.string   "company"
    t.string   "university"
    t.date     "timepperiodfrom"
    t.date     "timeperiodto"
    t.date     "universityStart"
    t.date     "universityEnd"
    t.string   "image"
    t.string   "industry"
